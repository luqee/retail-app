# Generated by Django 3.2.2 on 2021-05-10 17:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0002_auto_20210510_2036'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outlet', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('name',),
            },
